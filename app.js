  ...
  try {
    ...
    if (urlExists) {
      res.render("index", {
        ...
        // short_url: `https://url-shortener-1-z5w2.onrender.com:${process.env.PORT}/${urlExists.shortId}`,
      });
      return;
    }
    ...
    res.render("index", {
      ...
      // short_url: `https://url-shortener-1-z5w2.onrender.com:${process.env.PORT}/${result.shortId}`,
    });
  } catch (err) {
    next(err);
  }
